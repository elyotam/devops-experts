...
<p align="center">
  ...
  <img alt="ריפו ציבורי" src="https://img.shields.io/badge/%D7%A8%D7%99%D7%A4%D7%95-%D7%A6%D7%99%D7%91%D7%95%D7%A8%D7%99-2ea043">
</p>
...
הריפו הזה מרכז את **כל חומר הלימוד מקורס ה‑DevOps שאני עושה במכללת [DevOps Experts](https://devopsexperts.co.il/)**, מחזור **1125**. זה ארכיון אישי — הכל במקום אחד כדי שאוכל לחזור לכל שיעור, להריץ מחדש כל תרגיל ולהיזכר בפקודה שכבר עשיתי פעם.
...
- **הריפו ציבורי.** חלק מהסקריפטים מפנים לקישורי `raw.githubusercontent.com` של מאגר הקורס המקורי, והם ממשיכים לעבוד. אפשר גם למשוך קבצים ישירות מהריפו הזה, בלי אימות.
